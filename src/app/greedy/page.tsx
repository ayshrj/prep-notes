...
import { greedyLinks } from "@/constants/greedy-links";
...
const DP_PROGRESS_KEY = "greedy-progress-statuses";
...
export default function DSAProblemTracker() {
  ...
  const createInitialData = () => {
    return greedyLinks.map((link, i) => {
      const category = "Greedy";
